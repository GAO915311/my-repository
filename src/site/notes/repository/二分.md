---
{"dg-home":true,"dg-publish":true,"permalink":"/repository//","tags":["gardenEntry"],"dgPassFrontmatter":true,"noteIcon":"","created":"","updated":""}
---
...
思考：二分的本质是**两段性**，并非单调性，==一段满足某个性质，另一段不满足某个性质就可以用二分==。
